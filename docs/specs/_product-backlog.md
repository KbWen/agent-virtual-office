...
| AVO-106 | Pair-programming huddle | product | multi-agent | P1 | docs/specs/pair-programming-huddle.md | feature | Done | shared-file huddle; per-agent activeFile + never-random event (PR #80) |
