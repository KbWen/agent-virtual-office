...
// Single global phase hint from the (string) activeWorkflow. Restricted to review/ship; anything
// else, including null, returns null so callers do not invent a gate type.
...
// Returns { count, names, phaseGlyph }. names are raw agent ids; renderers localize separately.
...
// Visual sheet cap — N waiters aggregate into at most this many sheets; the true N is count.
