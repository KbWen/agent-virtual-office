...
- **Deferred for human decision**: the 2 MED bugs above; P0 AVO-101/108 (need hook-payload data); pre-existing validator FAILs (README mojibake/EOL, clickable-office-objects spec missing Domain Decisions); visual backlog (aesthetic review).
